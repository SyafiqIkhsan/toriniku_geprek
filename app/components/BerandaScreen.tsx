    ...
    <div className="flex flex-col min-h-full">
      ...
      <div className="bg-orange-500 px-5 md:px-8 pt-8 pb-8 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-start justify-between">
          <div>
            ...
            <p className="text-orange-100 text-sm mt-0.5">Wilujeng Sumping, {userEmail.split("@")[0]}! 👋</p>
          </div>
      ...
      <div className="flex-1 px-5 md:px-8 pt-6 pb-24 md:pb-8 bg-gray-50">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-4">
          ...
          <button id="btn-tambah-laba" className="bg-white rounded-2xl p-4 flex items-center gap-3 shadow-sm hover:shadow-md active:scale-[0.98] text-left cursor-pointer">
          ...
          <div className="bg-white rounded-2xl p-4 shadow-sm">
            ...
            {menuLoading ? <Skeleton className="h-7 w-8 mt-1 mb-1" /> : <p className="text-2xl font-bold text-gray-800 mt-1">{activeMenuCount}</p>}
            <p className="text-xs text-gray-400">produk tersedia</p>
          </div>

          <div className="bg-white rounded-2xl p-4 shadow-sm">
            <p className="text-xs text-gray-500">Order Selesai</p>
            {ordersLoading ? <Skeleton className="h-7 w-8 mt-1 mb-1" /> : <p className="text-2xl font-bold text-orange-500 mt-1">{completedOrders.length}</p>}
