    ...
    <div className="flex flex-col h-full">
      ...
      <div className="bg-orange-500 px-5 pt-12 pb-6 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-3">
          <button
            ...
            onClick={() => { setActiveTab("menu"); setActiveScreen("menu"); }}
      ...
      <div className="flex-1 overflow-y-auto px-4 py-5 pb-24 bg-gray-50">
        <div className="bg-white rounded-2xl p-5 shadow-sm">
          <h2 className="text-base font-bold text-gray-800 mb-4">Menu</h2>
          ...
          {/* Name */}
          <div className="mb-4">
            <label htmlFor="input-menu-name" className="block text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wide">
              Nama Menu Baru
            </label>
          ...
          {/* Price */}
          <div className="mb-4">
            <label htmlFor="input-menu-price" className="block text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wide">
              Harga (Rp)
            </label>
            <div className="relative">
          ...
          {/* Note */}
          <div className="mb-4">
            <label htmlFor="input-menu-note" className="block text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wide">
              Catatan Menu Baru
            </label>
            <div className="relative">
